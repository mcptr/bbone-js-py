define([
	...
	"../views/comments",
	"../views/related",
	"modules/comments/forms/comment",
	...
	var PostController = Controller.extend({
		...
		initializeNewCommentForm: function() {
			...
			this.newCommentForm = new CommentForm({
				el: "#main-content .layout-active .main-view .post-comments .comment-form",
			});
		...
		initializeCommentsView: function() {
			this.commentsView = new CommentsView({
				el: "#main-content .layout-active .main-view .post-comments .comments",
		...
		initializeRelatedPosts: function() {
			var view = new RelatedPostsView({
				el: "#main-content .layout-active .main-view .posts-related",
				model: this.postModel
			});
